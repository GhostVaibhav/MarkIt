...
int main() {
    ...
    #endif
    #ifdef _WIN32
    if(!exist("bin/test.exe") && !exist("bin/test_debug.exe") && !exist("test") && !exist("test_debug") &&! exist("test.o") && !exist("test.out") && !exist("test_debug.out") && !exist("generates") && !exist("clean") && !exist("build") && !exist("build.exe") && !exist("data.dat") && !exist("bin/data.dat")) {
