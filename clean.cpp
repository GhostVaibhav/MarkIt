...
#endif
#ifdef _WIN32
    if (!exist("bin/main.exe") && !exist("bin/main_debug.exe") && !exist("main") && !exist("main_debug") && !exist("main.o") && !exist("main.out") && !exist("main_debug.out") && !exist("clean") && !exist("build") && !exist("build.exe") && !exist("data.dat") && !exist("bin/data.dat"))
    {
