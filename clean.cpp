...
int main() {
  ...
  system("rm main > /dev/null 2>&1");
  system("rm build > /dev/null 2>&1");
  system("rm generates > /dev/null 2>&1");
  system("rm clean > /dev/null 2>&1");
#endif
#ifdef _WIN32
  if (!exist("bin/main.exe") && !exist("bin/main_debug.exe") &&
      !exist("main") && !exist("main_debug") && !exist("main.o") &&
      !exist("main.out") && !exist("main_debug.out") && !exist("clean") &&
      !exist("build") && !exist("build.exe") && !exist("data.dat") &&
      !exist("bin/data.dat")) {
    ...
    cout << "\u001b[31m    _   __      __     ________                         "
            " __\u001b[0m\n";
    cout << "\u001b[31m   / | / /___  / /_   / ____/ /__  ____ _____  ___  "
            "____/ /\u001b[0m\n";
    cout << "\u001b[31m  /  |/ / __ \\/ __/  / /   / / _ \\/ __ `/ __ \\/ _ "
            "\\/ __  /\u001b[0m\n";
    cout << "\u001b[31m / /|  / /_/ / /_   / /___/ /  __/ /_/ / / / /  __/ /_/ "
            "/\u001b[0m\n";
    cout << "\u001b[31m/_/ |_/\\____/\\__/   \\____/_/\\___/\\__,_/_/ "
            "/_/\\___/\\__,_/\u001b[0m\n\n";
  }
#elif __APPLE__
  if (!exist("bin/main.exe") && !exist("bin/main_debug.exe") &&
      !exist("main") && !exist("main_debug") && !exist("main.o") &&
      !exist("main.out") && !exist("main_debug.out") && !exist("generates") &&
      !exist("clean") && !exist("clean.exe") && !exist("build") &&
      !exist("build.exe") && !exist("data.dat") && !exist("bin/data.dat")) {
    cout << "   ________                          __\n";
    ...
    cout << "/_/ |_/\\____/\\__/   \\____/_/\\___/\\__,_/_/ "
            "/_/\\___/\\__,_/\n\n";
  }
#else
  if (!exist("bin/main.exe") && !exist("bin/main_debug.exe") &&
